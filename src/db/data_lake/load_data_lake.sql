...
copy data_lake.hd2023 from '/usr/src/data/institutional_characteristics/hd2023.csv' delimiter ',' csv header;
insert into data_lake.hd
(
    year
    , unitid
    , instnm
...
from 
    data_lake.hd2023;
drop table data_lake.hd2023;

create table data_lake.ic2023
(
...
copy data_lake.ic2023 from '/usr/src/data/institutional_characteristics/ic2023.csv' delimiter ',' csv header;
insert into data_lake.ic
(
    year
    , unitid
    , cntlaffi
...
from 
    data_lake.ic2023;
drop table data_lake.ic2023;


-- original file has an extra field at the end
create table data_lake.ic2023_py
(
...
copy data_lake.ic2023_py from '/usr/src/data/institutional_characteristics/ic2023_py.csv' delimiter ',' csv header;
insert into data_lake.ic_py
(
    year
    , unitid
    , prgmofr
...
from 
    data_lake.ic2023_py;
drop table data_lake.ic2023_py;


-- Enrollments

create table data_lake.effy2023
(
...
copy data_lake.effy2023 from '/usr/src/data/enrollments/effy2023.csv' delimiter ',' csv header;
insert into data_lake.effy
(
    year
    , unitid
    , effyalev
...
from 
    data_lake.effy2023;
drop table data_lake.effy2023;

create table data_lake.effy2023_dist
(
...
copy data_lake.effy2023_dist from '/usr/src/data/enrollments/effy2023_dist.csv' delimiter ',' csv header;
insert into data_lake.effy_dist
(
    year
    , unitid
    , effydlev
...
from 
    data_lake.effy2023_dist;
drop table data_lake.effy2023_dist;

create table data_lake.effy2023_hs
(
...
copy data_lake.effy2023_hs from '/usr/src/data/enrollments/effy2023_hs.csv' delimiter ',' csv header;
insert into data_lake.effy_hs
(
    year
    , unitid
    , efytotlt
...
select
    ...
    , cast(efytotlt as int)
from 
    data_lake.effy2023_hs;
drop table data_lake.effy2023_hs;

create table data_lake.efia2023
(
...
copy data_lake.efia2023 from '/usr/src/data/enrollments/efia2023.csv' delimiter ',' csv header;
insert into data_lake.efia
(
    year
    , unitid
    , efteug
...
from 
    data_lake.efia2023;
drop table data_lake.efia2023;


-- Completions

create table data_lake.c2023_a
(
...
copy data_lake.c2023_a from '/usr/src/data/completions/c2023_a.csv' delimiter ',' csv header;
insert into data_lake.c_a
(
    year
    , unitid
    , cipcode
...
from 
    data_lake.c2023_a;
drop table data_lake.c2023_a;

create table data_lake.c2023_b
(
...
copy data_lake.c2023_b from '/usr/src/data/completions/c2023_b.csv' delimiter ',' csv header;
insert into data_lake.c_b
(
    year
    , unitid
    , cstotlt
...
from 
    data_lake.c2023_b;
drop table data_lake.c2023_b;

create table data_lake.c2023_c
(
...
copy data_lake.c2023_c from '/usr/src/data/completions/c2023_c.csv' delimiter ',' csv header;
insert into data_lake.c_c
(
    year
    , unitid
    , awlevelc
...
from 
    data_lake.c2023_c;
drop table data_lake.c2023_c;

create table data_lake.c2023dep
(
...
copy data_lake.c2023dep from '/usr/src/data/completions/c2023dep.csv' delimiter ',' csv header;
insert into data_lake.cdep
(
    year
    , unitid
    , cipcode
